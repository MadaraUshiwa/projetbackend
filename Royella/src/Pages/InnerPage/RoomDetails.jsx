...
const RoomDetails = () => {
  ...
  const getAmenities = (arrayIds, amenitiesFct) => {
    const filteredAmenities = amenitiesFct.filter(amenity => arrayIds.includes(amenity.id));
            ...
            >
              ...
              <div className="grid items-center">
                {amenities ? amenities.map((amenity,index) => (
                  <div key={index} className="flex items-center py-5 border-b-[1px] border-lightGray dark:border-gray gap-5">
                    <i className={` ${amenity.image} text-khaki` } />
