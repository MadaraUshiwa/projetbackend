...
const Action = () => {
  ...
  return (
<>
  {manager ?     <div className="dark:bg-mediumBlack dark:z-[-1]">
      <section className="Container mt-[-90px] dark:z-[1]">
        <div  key={manager.id} className=" w-full grid grid-cols-1 lg:grid-cols-2 items-center ">
          <div
          ...
          <FsLightbox
            toggler={toggler}
            sources={hotel && hotel.video ? [hotel.video] : []}
          />
        </div>
      </section>
    </div> : <p>Loading...</p>}
