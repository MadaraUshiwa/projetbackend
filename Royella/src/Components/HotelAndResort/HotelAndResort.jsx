...
const HotelAndResort = () => {
    ...
    axios.get("http://127.0.0.1:8000/api/rooms/")
      .then((response) => {
        if (response.data.rooms) {
          ...
          setMaxRooms(getMaxRooms(response.data.rooms));
          setAvgRating(getRating(response.data.rooms));
        }
      })
      .catch((error) => {
        console.log(error);
  ...
  return (
    <>
    {hotel ? <section className="dark:bg-mediumBlack py-20 2xl:py-[120px]">
    <div
