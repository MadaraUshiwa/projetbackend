...
export default function Blog() {
    ...
    return (
        <div className='update-home h-full w-[100%]' data-aos="fade-up" data-aos-duration="1000" >
            <h1 className='titre pl-5 pt-3'><b>BLOGS</b></h1>
            <div className='update-home-content py-5 px-5 h-[90%] w-[100%]'>
                <div className='facilities-container h-[100%]'>
                    <div className='backoffice-header'>
                        <Link className='add' to={'/admin/blog/add'}><button>Ajouter</button></Link>
                    </div>
                            ...
                            <tbody>
                                {blogs ? blogs.map((blog, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{blog.title}</td>
                                        <td><img className='w-[40%] h-[100%]' src={`http://127.0.0.1:8000${blog.image}`} alt="" /></td>
                                        <td className='facilities-last-col'>
                                            <Link to={`/admin/blog/update/${blog.id}`}><i className="gg-edit-markup"></i></Link>
